...
- **Breakpoints mark structural changes, not tweaks**: A breakpoint should switch layout patterns (stack → side-by-side, hamburger menu → sidebar), not adjust padding by 4px.
