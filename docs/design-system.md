...
Sporty, energetic, mobile-first tennis pyramid ranking app. Bold greens evoking the court, warm accents for rankings and achievements. High contrast, tactile interactions, card-based layouts.
...
│  — tennis-specific, composed from Layer 1+2     │
├─────────────────────────────────────────────────┤
...
Reusable patterns from primitives. App-agnostic — no tennis/player/match awareness.
...
Tennis-specific. Composed from Layer 1+2. Contain business logic awareness.
